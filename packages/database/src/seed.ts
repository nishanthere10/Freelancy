...
async function seedDatabase() {
  ...
  try {
    ...
    const TARGET_USER_ID =
      process.env.SEED_USER_ID || "9f310b18-4459-4521-9213-66d24335d6ed";
    ...
    const [projectBrand] = await db
      ...
      .values({
        ...
        description:
          "Complete visual identity overhaul, logo suite, and Figma token system",
        status: "completed",
        pricingModel: "fixed",
    ...
    const [projectPortal] = await db
      ...
      .values({
        ...
        description:
          "High-performance Next.js marketing site with headless CMS integration",
        status: "active",
        pricingModel: "fixed",
    ...
    const [projectMarketing] = await db
      ...
      .values({
        ...
        description:
          "Social graphics, investor pitch deck, and trade show banners",
        status: "draft",
    ...
    await db
      ...
      .values([
        ...
        },
        {
          ...
          entityId: projectBrand.id,
          metadata: {
            entityName: "Brand Identity & Design System",
            fromStatus: "active",
            toStatus: "completed",
          },
