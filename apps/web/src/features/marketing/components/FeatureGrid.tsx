      ...
      <div className="max-w-[1280px] mx-auto px-8">
        <div className="mb-16 max-w-2xl">
          ...
          <p className="text-[18px] text-[var(--color-slate)] leading-relaxed">
            Ditch the scattered tools. Freelancy brings your clients, projects,
            and invoices into one beautiful space designed specifically for
        ...
        >
          ...
          <motion.div
            variants={item}
            className="md:col-span-7 group relative bg-[var(--color-brand-yellow)] p-8 rounded-[var(--radius-xxxl)] flex flex-col min-h-[400px] hover:shadow-[var(--shadow-card-hover)] transition-all duration-300 ease-out cursor-pointer overflow-hidden"
          >
            <div className="relative z-10">
              ...
              <h3 className="text-[28px] font-medium text-[var(--color-primary)] mb-3 tracking-[-0.02em]">
                Infinite Canvas
              </h3>
              <p className="text-[var(--color-primary)]/80 text-[18px] leading-relaxed max-w-sm mb-auto">
                Map out projects, draw user flows, and plan your week without
                boundaries.
              </p>
            </div>
          ...
          <motion.div
            variants={item}
            className="md:col-span-5 group relative bg-[var(--color-coral-light)] p-8 rounded-[var(--radius-xxxl)] flex flex-col min-h-[400px] hover:shadow-[var(--shadow-card-hover)] transition-all duration-300 ease-out cursor-pointer overflow-hidden"
          >
            <div className="relative z-10">
              <div className="w-14 h-14 bg-black/5 rounded-[var(--radius-xl)] flex items-center justify-center mb-8">
                <Users
              ...
              <p className="text-[var(--color-primary)]/80 text-[18px] leading-relaxed mb-8">
                Share progress instantly. Clients can comment directly on your
                boards in real-time.
              </p>
            </div>
            ...
            <div className="absolute right-0 bottom-0 w-full flex justify-end px-8 pb-8 pointer-events-none">
              <div className="flex -space-x-3 group-hover:space-x-1 transition-all duration-500">
                ...
                <div className="w-12 h-12 rounded-full bg-[var(--color-surface)] border-2 border-[var(--color-coral-light)] shadow-sm flex items-center justify-center text-[var(--color-slate)]">
          ...
          <motion.div
            variants={item}
            className="md:col-span-5 group relative bg-[var(--color-teal-light)] p-8 rounded-[var(--radius-xxxl)] flex flex-col min-h-[400px] hover:shadow-[var(--shadow-card-hover)] transition-all duration-300 ease-out cursor-pointer overflow-hidden"
          >
            <div className="relative z-10">
              <div className="w-14 h-14 bg-black/5 rounded-[var(--radius-xl)] flex items-center justify-center mb-8">
                <Receipt
              ...
              <p className="text-[var(--color-primary)]/80 text-[18px] leading-relaxed mb-auto">
                Turn project milestones into paid invoices with a single click.
                Get paid faster.
              </p>
            </div>
          ...
          <motion.div
            variants={item}
            className="md:col-span-7 group relative bg-[var(--color-brand-rose)] p-8 rounded-[var(--radius-xxxl)] flex flex-col min-h-[400px] hover:shadow-[var(--shadow-card-hover)] transition-all duration-300 ease-out cursor-pointer overflow-hidden"
          >
            <div className="relative z-10 w-full max-w-sm">
              ...
              <p className="text-[var(--color-primary)]/80 text-[18px] leading-relaxed mb-auto">
                Let AI draft proposals, generate wireframes, and organize your
                messy notes.
              </p>
            </div>
            ...
            <div className="absolute right-0 top-0 bottom-0 w-[50%] bg-gradient-to-l from-white/30 to-transparent flex items-center justify-end pr-8 pointer-events-none group-hover:pr-12 transition-all duration-500">
              <div className="w-full max-w-[200px] space-y-3">
                <div className="w-full bg-white/60 backdrop-blur-md rounded-[var(--radius-lg)] p-3 shadow-sm border border-white/50 flex gap-3 items-center transform translate-x-4">
                  <div className="w-6 h-6 rounded-full bg-[var(--color-brand-blue)] flex items-center justify-center text-white">
                ...
                <div className="w-[90%] bg-white/60 backdrop-blur-md rounded-[var(--radius-lg)] p-3 shadow-sm border border-white/50 flex gap-3 items-center">
                  <div className="w-6 h-6 rounded-full bg-[var(--color-brand-yellow)] flex items-center justify-center text-[var(--color-primary)]">
        ...
        <div className="mt-16 text-center">
          <Link
            href="/features"
            className="inline-flex items-center gap-2 text-[16px] font-medium text-[var(--color-brand-blue)] hover:text-[var(--color-blue-pressed)] transition-colors"
          >
