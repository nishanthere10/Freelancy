          ...
          <div className="text-left">
            ...
            >
              <h1 className="text-[52px] md:text-[68px] lg:text-[80px] font-medium leading-[1.05] tracking-[-0.02em] text-[var(--color-ink)] mb-6">
                See how freelancers get{" "}
                <span className="text-[var(--color-brand-blue)] relative inline-block whitespace-nowrap">
                  great
                  <svg
                    className="absolute w-full h-3 -bottom-1 left-0 text-[var(--color-brand-yellow)]"
                    viewBox="0 0 100 10"
              ...
              <p className="text-[18px] md:text-[22px] text-[var(--color-charcoal)] font-normal leading-[1.5] max-w-xl mb-10">
                The visual workspace for independent professionals. Manage
                projects, collaborate with clients, and organize your business
                in one limitless canvas.
              </p>
            </motion.div>
          ...
          >
            ...
            <div className="w-full h-full min-h-[400px] lg:min-h-full bg-[var(--color-canvas)] rounded-[var(--radius-feature)] border border-[var(--color-hairline-soft)] shadow-[var(--shadow-mockup)] overflow-hidden relative group z-10">
              ...
              <div className="absolute left-0 top-0 bottom-0 w-[60px] bg-[var(--color-canvas)] border-r border-[var(--color-hairline-soft)] z-20 flex flex-col items-center py-4 gap-4 shadow-sm">
                <div className="w-10 h-10 rounded-[var(--radius-md)] bg-[var(--color-surface-soft)] flex items-center justify-center text-[var(--color-brand-blue)] cursor-pointer">
                  <Cursor size={20} weight="fill" />
                </div>
                <div className="w-10 h-10 rounded-[var(--radius-md)] flex items-center justify-center hover:bg-[var(--color-surface)] cursor-pointer text-[var(--color-slate)]">
                  <Layout size={20} />
                </div>
                <div className="w-10 h-10 rounded-[var(--radius-md)] flex items-center justify-center hover:bg-[var(--color-surface)] cursor-pointer text-[var(--color-slate)]">
                ...
                <div className="mt-auto w-10 h-10 rounded-[var(--radius-md)] flex items-center justify-center hover:bg-[var(--color-surface)] cursor-pointer text-[var(--color-slate)]">
                  <Gear size={20} />
                </div>
              </div>
              ...
              <div className="absolute top-4 left-[80px] right-4 z-20 flex justify-between items-center pointer-events-none">
                <div className="bg-[var(--color-canvas)]/90 backdrop-blur-md px-4 py-2 rounded-[var(--radius-lg)] shadow-sm border border-[var(--color-hairline-soft)] flex items-center gap-3">
                  ...
                  <span className="text-[14px] font-medium text-[var(--color-ink-deep)]">
                    Website Redesign — Q3
                  </span>
                ...
                <div className="flex gap-2">
                  <div className="w-9 h-9 rounded-full bg-[var(--color-brand-yellow)] border-2 border-[var(--color-canvas)] shadow-sm flex items-center justify-center font-bold text-[12px] text-[var(--color-primary)]">
                    KF
                  </div>
                  <div className="w-9 h-9 rounded-full bg-[var(--color-brand-blue)] text-white border-2 border-[var(--color-canvas)] shadow-sm -ml-4 flex items-center justify-center font-bold text-[12px]">
                    Alex
                  </div>
              ...
              <div className="absolute inset-0 pl-[60px] bg-[#fafafa] overflow-hidden">
                ...
                >
                  <div className="relative">
                    <Cursor
                      size={28}
                      weight="fill"
                      className="text-[var(--color-brand-blue)] drop-shadow-md"
                    />
                ...
                >
                  ...
                  <div className="text-[var(--color-primary)] font-medium text-[18px] lg:text-[20px] leading-tight mb-2">
                    Define MVP scope with client
                  </div>
                  <div className="text-[var(--color-primary)]/70 text-[13px]">
                    Due by Friday EOD.
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="text-[var(--color-primary)] font-medium text-[18px] lg:text-[20px] leading-tight mb-3">
                    Review wireframes & sign off
                  </div>
                ...
                >
                  <div className="flex items-center gap-3 mb-5">
                    <div className="w-10 h-10 rounded-[var(--radius-md)] bg-[var(--color-brand-blue)] flex items-center justify-center text-white">
                      <CheckCircle size={24} weight="fill" />
                    </div>
                    <div className="flex-1">
                      <div className="text-[14px] font-medium text-[var(--color-ink-deep)] leading-none mb-1">
                        Brand Assets
                      </div>
                  ...
                  <div className="flex gap-2 mb-5">
                    <div className="h-12 flex-1 bg-[var(--color-surface-soft)] rounded-[var(--radius-md)] border border-[var(--color-hairline)] flex items-center justify-center text-[var(--color-slate)] text-[10px] font-medium">
                      Logo.svg
                    </div>
                    <div className="h-12 flex-1 bg-[var(--color-surface-soft)] rounded-[var(--radius-md)] border border-[var(--color-hairline)] flex items-center justify-center text-[var(--color-slate)] text-[10px] font-medium">
                      Font.zip
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-[var(--color-hairline-soft)]">
                    <div className="px-3 py-1 bg-[var(--color-success-accent)]/10 text-[var(--color-success-accent)] text-xs font-bold rounded-[var(--radius-full)]">
                      Approved
                    </div>
                    <div className="text-[11px] text-[var(--color-slate)] font-medium">
                      Just now
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <path
                    d="M 230 180 C 280 180, 280 250, 320 250"
