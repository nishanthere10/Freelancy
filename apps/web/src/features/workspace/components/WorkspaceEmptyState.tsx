  ...
  return (
    <div className="flex flex-col items-center justify-center py-28 px-4">
      <div className="text-center max-w-sm">
        ...
        {/* Description */}
        <p
          className="text-sm leading-relaxed mb-8 block mx-auto"
          style={{ color: "var(--color-slate-text)" }}
        >
          Create your first workspace to get started. Workspaces help you
          organize your projects, clients, and invoices in one place.
        </p>
