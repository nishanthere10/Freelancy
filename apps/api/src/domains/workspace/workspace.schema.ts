...
export const createWorkspaceMemberSchema = z.object({
  ...
  invitedBy: z.string()
    .uuid('Invited by must be a valid UUID')
    .optional(),
}).strict(); // Reject unknown fields
...
export type UpdateWorkspaceMemberSchema = z.infer<typeof updateWorkspaceMemberSchema>;
...
export const workspaceMemberQuerySchema = z.object({
